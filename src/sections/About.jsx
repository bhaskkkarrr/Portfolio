...
const About = () => {
  return (
    <>
      <section
        id="about"
        className="w-full h-fit relative md:w-xl lg:w-5xl xl:w-7xl max-w-8xl mx-auto px-4 transition-all duration-300 my-10"
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 ">
          ...
          <div className="flex flex-col justify-between">
            <motion.div
              ...
              className=" justify-center items-start flex my-10"
            >
              <img
                src={profile}
          ...
          <div className="space-y-2 lg:space-y-8">
            ...
            <div className="md:text-lg text-base flex flex-col justify-center items-center">
              ...
              solve real-world problems. I specialize in the MERN stack
              (MongoDB, Express.js, React.js, and Node.js).
              <br /> <br /> I have hands-on experience working with technologies
              like JavaScript,React, Node.js, MongoDB, WebSockets, HTML, CSS,
              and Tailwind.
      ...
      <div className="w-full flex justify-center">
        <div className="h-px w-2/3 bg-linear-to-r from-transparent via-amethyst-smoke-950 to-transparent" />
      </div>
    </>
  );
};
