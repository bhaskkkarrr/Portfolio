...
const Footer = () => {
  return (
    <section
      id="footer"
      className="w-full h-fit flex flex-col items-center justify-center overflow-hidden my-15 gap-2 space-y-4"
    >
      <span className="text-center text-4xl font-semibold name ">Bhaskar Chauhan</span>
