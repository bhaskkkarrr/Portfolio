  ...
  return (
    <section id="home" className="w-full h-screen relative ">
      ...
      <div className="relative h-full w-full md:w-xl lg:w-5xl xl:w-7xl max-w-8xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 transition-all duration-300">
        {/* DP */}
        <div className="flex xl:hidden mt-15 lg:mt-0 relative justify-center items-center">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{
              opacity: 1,
            ...
            className="h-60 w-60 md:h-80 md:w-80 lg:h-100 lg:w-100 transition-all duration-300"
          >
            <img
              src={profile}
              alt="profile"
        ...
        <div className="flex flex-col h-full justify-center text-center lg:text-left relative">
          <div className="w-full mx-auto max-w-4xl">
            <motion.div className="flex flex-col  lg:items-start space-y-6 xl:space-y-8 ">
              {/* TypeWriter Effect */}
              <div className="name text-xl lg:text-4xl">
                <Typewriter
                  options={{
              ...
              {/* Name */}
              <div className="">
                <div className="text-dark-amethyst-200 text-4xl lg:font-medium lg:text-5xl">
                  Hello, I'm
                </div>
                <div className="text-4xl lg:text-5xl xl:text-6xl lg:font-bold">
                  Bhaskar Chauhan
                </div>
              </div>
              {/* Caption */}
        ...
        <div className="xl:flex hidden mt-15 lg:mt-0 relative justify-center items-center">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{
              opacity: 1,
            ...
            transition={{ type: "spring", stiffness: 300 }}
            whileHover={{ scale: 1.1 }}
            className="h-60 w-60 md:h-80 md:w-80 lg:h-100 lg:w-100 "
          >
            <img
              src={profile}
              alt="profile"
